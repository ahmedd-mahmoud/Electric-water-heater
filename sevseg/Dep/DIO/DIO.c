...
void DIO_setPinDir(char port,uint8 pin,Bool dir)
{
	...
	if (port == 'A' || port == 'a')
	{
		ASSIBIT(DDRA,pin,dir);
	}
	else if(port == 'B' || port == 'b') 
	{
		ASSIBIT(DDRB,pin,dir);
	}
	else if(port == 'C' || port == 'c')
	{
		ASSIBIT(DDRC,pin,dir);
	}
	else //  portD is the default port
	{
		ASSIBIT(DDRD,pin,dir);
	}
...
{	
	if (port == 'A' || port == 'a')
	{
		ASSIBIT(PORTA,pin,state);
	}
	else if(port == 'B' || port == 'b')
	{
		ASSIBIT(PORTB,pin,state);
	}
	else if(port == 'C' || port == 'c')
	{
		ASSIBIT(PORTC,pin,state);
	}
	else //  portD is the default port
	{
		ASSIBIT(PORTD,pin,state);
	}
}
